...
<div class="article-summary p-4 my-4">
    ...
    {if $publication->getLocalizedData('abstract')}
		<div class="article-summary-abstract p-3 mt-2">
		<h2 class="article-summary-abstract-heading collapsed my-0" type="button" data-toggle="collapse" data-target="#abs-{$publication->getId()}" aria-expanded="false" aria-controls="collapseExample"><span class="arrow">&#9650;</span>{translate key="article.abstract"}</h2>
						<div class="collapse" id="abs-{$publication->getId()}">{$publication->getLocalizedData('abstract')|strip_unsafe_html}</div>
		</div>
	{/if}
